...
package_name=dev.co508.emotiontracker
...
branch_status=0
git ls-remote --exit-code --heads "$remote" gh-pages > /dev/null || branch_status=$?
if ((branch_status == 0)); then
    ...
    echo "Cannot read gh-pages; refusing to replace the existing repository." >&2
    exit "$branch_status"
fi
...
[[ $fingerprint =~ ^[0-9a-f]{64}$ ]] || { echo "Cannot read index signing fingerprint" >&2; exit 1; }
...
<title>Emotion Tracker &mdash; F-Droid repository</title>
<style>
...
<a href="https://github.com/508-dev/emotion-tracker">Emotion Tracker</a>.</p>
...
uninstalling. Compatibility with <em>f-droid.org</em> builds depends on their
accepted signing configuration; verify the APK certificate before switching.</p>
<p><a href="privacy-policy.html">Privacy policy</a></p>
<p><a href="https://github.com/508-dev/emotion-tracker">Source code</a> &middot; GPL-3.0</p>
</html>
""")
PY
...
cp "$repo_root/docs/privacy-policy.html" "$pages/privacy-policy.html"
touch "$pages/.nojekyll"
git -C "$pages" add \
    index.html privacy-policy.html .nojekyll fdroid/.gitignore fdroid/repo fdroid/metadata
